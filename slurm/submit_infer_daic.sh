...
#SBATCH --time=3:59:00
#SBATCH --gres=gpu:1
#SBATCH --output=/home/nfs/svacanas/outputs/infer_slurm_%j.out
#SBATCH --error=/home/nfs/svacanas/outputs/infer_slurm_%j.err

module use /opt/insy/modulefiles
module load cuda/12.1

NEON=/tudelft.net/staff-umbrella/neon
VITPOSE_DIR=/home/nfs/svacanas/ViTPose
